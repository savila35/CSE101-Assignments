...
// equals()
// Return true (1) if matricies A and B are equal, false (0) otherwise.
...
// not printed. Each non-zero row is represented as one line consisting of the 
// row number, followed by a colon, a space, then a space separated list of 
// pairs "(col, val)" giving thw column number and non-zero values in that row.
